...
public class ResultMapping {
  ...
  private String property; //对应节点的property属性，表示列的映射属性
  private String column; //对应节点的column属性，表示是从数据库中得到的列明或者列明的别名
  private Class<?> javaType;//对应的java类型
  private JdbcType jdbcType;//对应的数据库类型
  private TypeHandler<?> typeHandler;//对应的类型转换器类型
  private String nestedResultMapId;//
  private String nestedQueryId;
  private Set<String> notNullColumns;//对应节点的notNullColumn属性拆分后的结果
  private String columnPrefix;//对应节点Prefix属性
  private List<ResultFlag> flags;//处理后的标志
  private List<ResultMapping> composites; //对应节点的column 属性拆分后生成的集合， composites.size () >0 会使column 为null
  private String resultSet; //对应节点resultSet属性
  private String foreignColumn;//对应foreignColumn属性
